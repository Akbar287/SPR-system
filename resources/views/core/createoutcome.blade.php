                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="hero bg-primary text-white">
                            <div class="hero-inner">
                                <h2>{{ $total }}</h2>
                                <p class="lead">Total Pengeluaran Bulan Ini</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-10 col-lg-10">
                        <div class="card card-primary shadow" style="margin-top: -30px;">
                            <div class="card-header">
                                <h4>Tambahkan Catatan Pengeluaran</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{url('outcome')}}" method="POST" enctype="multipart/form-data"> @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="outcome">Biaya</label>
                                                <input type="text" name="outcome" class="currency form-control @error('outcome') is-invalid @enderror" id="outcome" >
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <img src="" class="rounded mx-auto img-thumbnail img-responsive" id="img-outcome">
