                        ...
                        <div class="card card-primary shadow" style="margin-top: -30px;">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <h4><a href="{{url('/outcome/create')}}" style="border-radius: 20px;" class="btn btn-outline-primary btn-lg btn-icon icon-left"><i class="fas fa-plus"></i></a></h4>
                                </div>
                            </div>
                            <div class="card-body">
                                @if(!empty($outcome))
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ url('outcome/'.$out['id']) }}" class="btn btn-primary" title="Ubah"><i class="fas fa-pen"></i></a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
